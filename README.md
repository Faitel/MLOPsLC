...
4. Launch Houdini and open the tab menu. Click on Pip install shelft tool and put the string in Dependencies field: rembg[gpu], sentence-transformers, matplotlib  Click install. 
